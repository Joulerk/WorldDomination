...
<div class="container mt-5">
    <h1 class="text-center display-4 mb-4">Редактирование настроек <i class="material-icons">settings</i></h1>
    <form action="edit_settings_process.php?room=<?php echo urlencode($room_name); ?>" method="POST">
        <?php if ($settings): ?>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card shadow-sm animated fadeIn">
                        <div class="card-body">
                            <h5 class="card-title"><i class="material-icons">tune</i> Настройки</h5>
                            <?php foreach ($settings as $key => $value): ?>
                                <div class="form-group">
                                    <label for="<?php echo $key; ?>"><i class="material-icons">settings</i> <?php echo ucfirst(str_replace('_', ' ', $key)); ?></label>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <button type="submit" name="reset" value="1" class="btn btn-secondary btn-lg btn-block mt-3"><i class="material-icons">restore</i> По умолчанию</button>
                </div>
            </div>
        <?php else: ?>
            <div class="alert alert-warning">
                <p><i class="material-icons">warning</i> Настройки не найдены. Пожалуйста, создайте файл настроек.</p>
            </div>
        <?php endif; ?>
    </form>
</div>
