            ...
            <div class="card text-center shadow-sm">
                <div class="card-body">
                    ...
                    <form action="edit_cities.php" method="get">
                        ...
                        <button type="submit" class="btn btn-info btn-lg btn-block">Редактировать</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="card text-center shadow-sm">
                <div class="card-body">
                    ...
                    <form action="edit_settings.php" method="get">
                        ...
                        <button type="submit" class="btn btn-secondary btn-lg btn-block">Настройки</button>
                    </form>
                </div>
            </div>
        </div>
