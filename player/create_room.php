    ...
    if (count($rooms_data) >= 15) {
        ...
        if ($room_exists) {
            ...
            $countries = [
                ...
                ["name" => "Россия", "cities" => ["Москва", "Санкт-Петербург", "Новосибирск", "Екатеринбург"]],
                ["name" => "Китай", "cities" => ["Пекин", "Шанхай", "Гуанчжоу", "Шэньчжэнь"]],
                ["name" => "Германия", "cities" => ["Берлин", "Гамбург", "Мюнхен", "Кёльн"]],
                ["name" => "Франция", "cities" => ["Париж", "Марсель", "Лион", "Тулуза"]],
                ["name" => "Индия", "cities" => ["Нью-Дели", "Мумбаи", "Бангалор", "Ченнай"]],
                ["name" => "Бразилия", "cities" => ["Сан-Паулу", "Рио-де-Жанейро", "Бразилиа", "Салвадор"]],
                ["name" => "Япония", "cities" => ["Токио", "Осака", "Йокогама", "Нагоя"]],
                ["name" => "Канада", "cities" => ["Торонто", "Ванкувер", "Монреаль", "Калгари"]],
                ["name" => "Австралия", "cities" => ["Сидней", "Мельбурн", "Брисбен", "Перт"]],
                ["name" => "Южная Корея", "cities" => ["Сеул", "Пусан", "Инчхон", "Тэгу"]],
                ["name" => "Италия", "cities" => ["Рим", "Милан", "Неаполь", "Турин"]]
            ];
            ...
            // Устанавливаем время удаления комнаты через 4 часа
            setRoomDeleteTime($room_name, time() + 4 * 60 * 60);
